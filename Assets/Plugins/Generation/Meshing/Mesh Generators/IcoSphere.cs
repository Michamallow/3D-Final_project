...
namespace Generation.Meshing
{
	public static class IcoSphere
	{
		...
		public static SimpleMeshData Generate(int resolution, float radius = 1)
		{
			...
			FixedSizeList<Vector3> vertices = new FixedSizeList<Vector3>(numVerts);
			FixedSizeList<int> triangles = new FixedSizeList<int>(numTrisPerFace * 8 * 3);
			...
			SimpleMeshData meshData = new SimpleMeshData(vertices.items, triangles.items, normals, name: "Ico Sphere");
			return meshData;
