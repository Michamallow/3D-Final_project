...
namespace Generation.MathsHelper
{
	public class PolygonPointGenerator
	{
		...
		public PolygonPointGenerator(Vector2[] polygonPoints)
		{
			...
			Generation.MathsHelper.Triangulation.Polygon polygon = new Triangulation.Polygon(polygonPoints);
			triangles = Generation.MathsHelper.Triangulation.Triangulator.Triangulate(polygon);
