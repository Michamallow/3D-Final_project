...
namespace Maths
{
	...
	public static class Polygon
	{
		...
		{
			return new Generation.MathsHelper.PolygonPointGenerator(polygon).GetRandomPoints(numPoints);
		}

		public static Vector2[] RandomPointsInside(Vector2[] polygon, int numPoints, int seed)
		{
			var gen = new Generation.MathsHelper.PolygonPointGenerator(polygon);
			gen.SetSeed(seed);
		...
		{
			return Generation.MathsHelper.Triangulation.Triangulator.Triangulate(polygon);
		}
